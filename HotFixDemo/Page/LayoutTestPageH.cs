...
public class LayoutTestPageH :HotFix. UIPage
{
    class View
    {
...
public class GridTestWindow :HotFix.PopWindow
{
    class View
    {
...
public class GridTestWindow2 : HotFix.PopWindow
{
    class View
    {
...
public class TestMenu : HotFix.MenuWindow
{
    class View
    {
    ...
    View view;
    public override void Initial(ModelElement parent,HotFix.UIBase ui, object obj = null)
    {
